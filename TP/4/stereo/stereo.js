...
function initTextures() {
    ...
    image.src='robot_gauche.png';
    image2.src='robot_droite.png';

}


function drawRight() {
    gl.viewport(viewportWidth/2,0,300, viewportHeight);
    ...
    mat4.translate(view,view,[0.05,0.0,-3.5]);
...
function draw() {
    ...
    var view = mat4.create();
    mat4.identity(view, view);
    mat4.translate(view,view,[0.1,0.0,-3.5]);

    //mat4.lookAt(view, [0,0, 3.5], [0, 0,0], [0,1,0]);
    gl.uniformMatrix4fv(uPMatrix, false, projMatrix);
    gl.uniformMatrix4fv(uMVMatrix, false, view);
    gl.viewport(0,0,300, viewportHeight);
